...
| 2 | AST + static getter→folder table | `SyntaxTree`, no `SemanticModel` needed in practice | shipped 2026-05-04 |
| 3 | Semantic analysis (binding + flow) | `SemanticModel` | proposed |
| 4 (deferred) | Same as 3 | `SemanticModel`, type hierarchy walks | deferred |
