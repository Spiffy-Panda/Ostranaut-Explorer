...
def item_def(name: str, base_def: str) -> dict:
...
def main() -> int:
    ...
    for item in cfg["items"]:
        suffix = item["suffix"]
        entries.append(item_def(f"ItmSack{suffix}", sprite_cfg["sack_base"]))
        entries.append(item_def(f"ItmBucket{suffix}", sprite_cfg["bucket_base"]))
